...
import vrl.annotation.OutputInfo;
import vrl.annotation.ParamInfo;
import vrl.math.TrajectoryDefaultType;
import vrl.reflection.DefaultMethodInfo;
import vrl.reflection.DefaultOutputInfo;
import vrl.reflection.DefaultParamInfo;
import vrl.reflection.RepresentationType;
import vrl.reflection.TypeRepresentationBase;
import vrl.reflection.TypeRepresentationFactory;
import vrl.reflection.TypeUtil;
import vrl.reflection.UnsupportedType;
import vrl.system.VClassLoaderUtil;
import vrl.types.AddToCanvasType;
import vrl.types.ArrayBaseType;
import vrl.types.BooleanArrayType;
import vrl.types.BooleanInputType;
import vrl.types.BooleanOutputType;
import vrl.types.BufferedImageArrayInputType;
import vrl.types.BufferedImageType;
import vrl.types.ClassNameType;
import vrl.types.CodeBlockType;
import vrl.types.ColorArrayType;
import vrl.types.ColorInputType;
import vrl.types.ColorType;
import vrl.types.ContainerOutputType;
import vrl.types.DVectorType;
import vrl.types.DoubleArrayType;
import vrl.types.DoubleType;
import vrl.types.FileListType;
import vrl.types.FileType;
import vrl.types.FloatArrayType;
import vrl.types.FloatType;
import vrl.types.Function1DType;
import vrl.types.Function2DType;
import vrl.types.Function3DType;
import vrl.types.FunctionType;
import vrl.types.GetCanvasType;
import vrl.types.GetCanvasWindowType;
import vrl.types.GetMethodRepresentationType;
import vrl.types.GetObjectRepresentation;
import vrl.types.GetSelectedObjectsType;
import vrl.types.GetVisualIDType;
import vrl.types.GroovyFunction1DType;
import vrl.types.GroovyFunction2DType;
import vrl.types.GroovyFunction3DType;
import vrl.types.HtmlOutputType;
import vrl.types.ImageType;
import vrl.types.InputCodeType;
import vrl.types.InputTextType;
import vrl.types.InputValueType;
import vrl.types.IntSilentType;
import vrl.types.IntSliderTextFieldType;
import vrl.types.IntSliderType;
import vrl.types.IntegerArrayType;
import vrl.types.IntegerExceptionTestType;
import vrl.types.IntegerSelectionInputType;
import vrl.types.IntegerType;
import vrl.types.LoadFileArrayArrayType;
import vrl.types.LoadFileArrayType;
import vrl.types.LoadFileStringType;
import vrl.types.LoadFileType;
import vrl.types.LoadFolderType;
import vrl.types.LongArrayType;
import vrl.types.LongType;
import vrl.types.MessageOutputType;
import vrl.types.MessageTypeSelectionType;
import vrl.types.MethodNameType;
import vrl.types.MultipleOutputType;
import vrl.types.ObjectSilentType;
import vrl.types.ObjectType;
import vrl.types.OutputTextType;
import vrl.types.OutputValueType;
import vrl.types.PackageNameType;
import vrl.types.ParameterGroupType;
import vrl.types.PluginNameType;
import vrl.types.PluginVersionType;
import vrl.types.ResolutionSelectionType;
import vrl.types.SaveFileArrayType;
import vrl.types.SaveFileStringType;
import vrl.types.SaveFileType;
import vrl.types.SaveFolderStringType;
import vrl.types.SaveFolderType;
import vrl.types.SelectionInputType;
import vrl.types.SelectionOutputType;
import vrl.types.ShortType;
import vrl.types.StringArrayType;
import vrl.types.StringSelectionInputType;
import vrl.types.StringSilentArrayType;
import vrl.types.StringSilentType;
import vrl.types.StringType;
import vrl.types.VariableNameType;
import vrl.types.VoidType;
import vrl.types.observe.LoadObserveFileStringType;
import vrl.types.observe.LoadObserveFileType;
import vrl.types.observe.SaveObserveFileType;
 ...
 */
final public class TypeBuilder implements
...
//        defaultSupportedTypes.add(VGeometry3DAppearanceType.class);
     ...
     */
    public TypeBuilder(Canvas mainCanvas) {
        ...
        for (Class<? extends TypeRepresentationBase> t : availableRepresentations) {
            ...
            if (style.equals(representationStyle)) {
                ...
                try {
                    ...
                    Logger.getLogger(TypeBuilder.class.getName()).
