 ...
 */
@TypeInfo(type=File[].class, input = true, output = false, style="save-dialog")
public class SaveFileArrayType extends TypeRepresentationBase {
    ...
    public SaveFileArrayType() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                files = fileManager.getSaveFiles(getMainCanvas(),
