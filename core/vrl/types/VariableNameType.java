...
public class VariableNameType extends StringType {

    public VariableNameType() {
        setValueName("Variable-Name:");
    }
    ...
    protected void evaluateContract() {
        ...
        if (!VLangUtils.isClassNameValid(s)) {
            getMainCanvas().getMessageBox().addMessage("Variable-Name invalid:",
