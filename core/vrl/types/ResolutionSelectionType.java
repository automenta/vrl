 ...
 */
@TypeInfo(type=ResolutionSelection.class, input = true, output = false, style="default")
public class ResolutionSelectionType extends SelectionInputType{
