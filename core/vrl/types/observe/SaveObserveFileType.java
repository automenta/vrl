 ...
 */
@TypeInfo(type = File.class, input = true, output = false, style = "observe-save-dialog")
public class SaveObserveFileType extends TypeRepresentationBase{
...
//                directory, getFileFilter(), false);
                File file = fileManager.getSaveFileOrFolder(getMainCanvas(),
