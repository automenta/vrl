 ...
 */
@TypeInfo(type = String.class, input = true, output = false, style = "save-dialog")
public class SaveFileStringType extends TypeRepresentationBase {
    ...
    public SaveFileStringType() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                file = fileManager.getSaveFile(getMainCanvas(),
