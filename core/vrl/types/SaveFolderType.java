 ...
 */
@TypeInfo(type = File.class, input = true, output = false, style = "save-folder-dialog")
public class SaveFolderType extends TypeRepresentationBase {
