 ...
 */
@TypeInfo(type=String.class, input = false, output = true, style="html")
public class HtmlOutputType extends TypeRepresentationBase {
    ...
    public HtmlOutputType() {
        ...
        textPane.setBackground(VSwingUtil.TRANSPARENT_COLOR);
        ...
        setInputDocument(textPane.getDocument());
