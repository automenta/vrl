...
public class IntegerExceptionTestType extends NumberBasedTypeRepresentation {

    /**
     * Constructor.
     */
    public IntegerExceptionTestType() {
        
        setRangeType(getType());
        nameLabel.setText("Integer:");
        
        throw new UnsupportedOperationException("not implemented (VRL-Test)");
    }
}
