/* 
 * GetMethodRepresentationType.java
 * 
...
public class GetMethodRepresentationType extends TypeTemplate implements VRLRequestType{

    public GetMethodRepresentationType() {
        setValueName("Method Representation");
    ...
    public Object getViewValue() {
        ...
        if (getMainCanvas() != null) {
            result = new MethodRequest(getParentMethod());
        }
