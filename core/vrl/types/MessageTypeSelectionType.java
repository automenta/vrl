...
@TypeInfo(type=MessageTypeSelection.class, input = true, output = false, style="selection")
public class MessageTypeSelectionType extends SelectionInputType {
