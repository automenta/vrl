 ...
 */
public class ArchiveFormatProvider {
    
    private static Map<String, ArchiveFormat> defaultFormats = 
            new HashMap<String, ArchiveFormat>();
    
    private static Map<String, ArchiveFormat> formats = 
            new HashMap<String, ArchiveFormat>();
