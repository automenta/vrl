/* 
 * CanvasBinarySessionLoader.java
 * 
...
/**
 * Binary session loader uses <code>java.io.Serializable;</code> to load a
 * binary representation of the session from file.
 * <p>
...
public class CanvasBinarySessionLoader implements FileLoader {
    ...
    public Object loadFile(File file) throws IOException {
        ...
        try {
            ...
            Logger.getLogger(CanvasBinarySessionLoader.class.getName()).
