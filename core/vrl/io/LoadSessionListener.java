...
/**
 * Interface for objects that want to be notified before a session is to be
 * loaded. This can be used to modifiy the canvas object that is created for the
...
public interface LoadSessionListener {
    /**
     * Invoked when load event occures.
