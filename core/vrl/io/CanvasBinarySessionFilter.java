/* 
 * CanvasBinarySessionFilter.java
 * 
...
/**
 * File extension filter for binary representation of VRL sessions.
 * <p>
...
public class CanvasBinarySessionFilter extends FileFilter {
    ...
    public boolean accept(File f) {
        return f.getName().toLowerCase().endsWith(".vrlb") ||
                f.isDirectory();
    }

    @Override
    public String getDescription() {
        return "Binary session Files (.vrlb)";
    }
}
