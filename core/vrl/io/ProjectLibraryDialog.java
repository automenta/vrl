...
import vrl.visual.VLayoutController;
import vrl.visual.VScrollPane;
import vrl.visual.VSplitPane;
            ...
            versionList.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (e.getClickCount() == 1) {
                        ...
                        int versionIndex = ((vrl.io.Version) versionList.getSelectedValue()).getVersion();
...
//            setMinimumSize(visibleRectDim);
        ...
        private void searchAndAddToResultList() {
            ...
            for (Object element : versionData) {
                ...
                if (element instanceof vrl.io.Version) {
