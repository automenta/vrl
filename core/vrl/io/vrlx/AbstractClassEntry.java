...
public class AbstractClassEntry {
    ...
    public AbstractClassEntry() {
        //
    }

    public AbstractClassEntry(ClassEntry entry) {
    ...
    public ClassFileObject asClassFile() {
        return new ClassEntry(this).asClassFileObject();
    }
}
