/* 
 * AbstractControlFlowConnections.java
 * 
 ...
 */
public class AbstractControlFlowConnections extends ArrayList<AbstractControlFlowConnection> {

    private static final long serialVersionUID = 2927803944975467253L;
//    public static final String NAME_KEY = "data-connections";

    /**
     * Adds the connections to a canvas.
     * @param mainCanvas the canvas the connections are to be added to
     */
    public void addToCanvas(VisualCanvas mainCanvas, Connections connections) {
        for (AbstractControlFlowConnection c : this) {
            try {
                c.addToCanvas(mainCanvas,connections);
            } catch (Exception ex) {
