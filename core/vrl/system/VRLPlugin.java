...
import vrl.lang.g4j.G4J;
import vrl.devel.CheckSumCreator;
import vrl.devel.LibraryMerger;
import vrl.devel.LibraryPluginCreator;
import vrl.devel.NativePluginCreator;
import vrl.devel.PluginContentAdder;
import vrl.io.IOUtil;
import vrl.io.VJarUtil;
import vrl.lang.CompilerProvider;
import vrl.lang.Keywords;
import vrl.lang.groovy.GroovyCodeEditorComponent;
import vrl.logging.MessageLogger;
import vrl.math.UserFunction;
import vrl.media.VideoCreator;
import vrl.reflection.ComponentManagementPanel;
import vrl.reflection.ControlFlowConnection;
...
import vrl.lang.visual.AddImportReplacementRule;
import vrl.lang.visual.ClassLoaderCompletionProvider;
import vrl.lang.visual.CompletionProviderGroup;
import vrl.lang.visual.CompletionUtil;
import vrl.lang.visual.EditorConfiguration;
import vrl.lang.visual.EditorProvider;
import vrl.lang.visual.InputObject;
import vrl.lang.visual.OutputObject;
import vrl.lang.visual.StartObject;
import vrl.lang.visual.StopObject;
import vrl.lang.visual.VAutoCompletion;
import vrl.lang.visual.VBasicCompletion;
import vrl.lang.visual.VShortHandCompletion;
...
import vrl.visual.SelectionRectangle;
...
//        }, ActionDelelator.CANVAS_MENU);
    ...
    private String readLicense() {
        ...
        String codeName = "/resources/license/lgplv3.txt";
    ...
    private void saveProjectTemplate() {
        InputStream in = VRLPlugin.class.getResourceAsStream(
                "resources/projects/VRL-Tutorial-1.vrlp");
        try {
