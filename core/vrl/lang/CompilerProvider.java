...
public interface CompilerProvider {
    ...
    public static final String LANG_NONE = "text";
    

    VCompiler getCompiler(String language) throws CompilerNotFoundException;
    
    Collection<VCompiler> getCompilers();

    /**
     * Registers a compiler with this compiler provider.
     * @param c compiler
     */
    void register(VCompiler c);
