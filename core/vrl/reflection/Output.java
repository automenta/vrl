...
{
    private static final long serialVersionUID = 833334016831075457L;
    /**
     * Creates a new instance of Output.
     * @param mainCanvas the main canvas object
     */
    public Output (VisualCanvas mainCanvas)
    {
        super(mainCanvas);
        
//        CanvasStyle style = getMainCanvas().getStyle();
        
//        setBackground(style.getOutputColor());
//        setInactiveColor(style.getOutputColor());
//        setActiveColor (style.getActiveOutputColor());

        setType(ConnectorType.OUTPUT);
    }
}
