...
public class UnsupportedType extends TypeTemplate {
    ...
    private static final long serialVersionUID = -3039106676870562720L;
...
//    private boolean classFound;
    ...
    public UnsupportedType(Class<?> type) {
        ...
        setValueName(typeName + " (U)");
        
        setWarningIfNoCodeGeneration(false);

    }
    
    @Override
    public boolean noSerialization() {
        // we do not serialize unsupported data
        return true;
    }
}
