...
import vrl.TypeBuilder;
import vrl.system.VClassLoader;
import vrl.io.vrlx.VSessionInitializer;
...
import vrl.lang.CompilerProviderImpl;
...
//    private boolean loadPluginsAsGlobal = false;
     ...
     */
    protected void init() {
        typeFactory = new TypeBuilder(this);
