 ...
 * be added to the clipboard of the main canvas. Usually it displays its
 * selection state by a colorizing effect (the whole component will be
 * colorized).
 * 
 * @author Michael Hoffer <info@michaelhoffer.de>
 */
public interface Selectable extends ShapeDescription{


    /**
     * Defines the selection state if the window.
     * @param value the selection state to set
     */
