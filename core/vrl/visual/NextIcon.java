 ...
 */
public class NextIcon extends JPanel implements CanvasChild, Serializable,
     ...
     */
    public NextIcon(Canvas mainCanvas) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isActive) {
            g2.setColor(style.getBaseValues().getColor(MessageBox.ACTIVE_ICON_COLOR_KEY));
        } else {
