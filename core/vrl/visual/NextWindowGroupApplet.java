...
/**
 * Dock applet with next window group functionality for presentation sessions.
 * @author Michael Hoffer <info@michaelhoffer.de>
 */
public class NextWindowGroupApplet extends DockApplet {

    /**
     * Constructor.
     * @param canvas the canvas
     */
    public NextWindowGroupApplet(final Canvas canvas) {
        super(canvas);
        ...
        setActionListener(new CanvasActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                canvas.getWindowGroupController().showNextGroup();
            }
        });
    }
    ...
    protected ImageIcon generateIcon(Dimension size) {
        ...
        Color color = getMainCanvas().getStyle().getBaseValues().getColor(
