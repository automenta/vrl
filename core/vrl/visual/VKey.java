...
//    private int modifiersEx;
    ...
    public VKey(int code) {
//        this.modifiers = 0;
//        this.modifiersEx = 0;
        this.code = code;
    }

//    public VKey(int modifiers, int modifiersEx, int ID) {
//        this.modifiers = modifiers;
//        this.modifiersEx = modifiersEx;
//        this.ID = ID;
//    }

    public VKey(KeyEvent keyEvent) {
...
//        if (other.getModifiers() != getModifiers()) {
//            return false;
//        }
//
//        if (other.getModifiersEx() != getModifiersEx()) {
//            return false;
//        }
