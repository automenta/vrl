...
public abstract class ValueAnimation extends Animation implements FrameListener{
    ...
    public ValueAnimation(double start, double stop) {
        this.valueTarget = new LinearInterpolation(start, stop);
        addInterpolation(valueTarget);
