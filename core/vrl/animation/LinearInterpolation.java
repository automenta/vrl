...
public class LinearInterpolation implements AnimationInterpolation {
     ...
     */
    public LinearInterpolation(double start, double stop) {
        setStartValue(start);
        setStopValue(stop);
    }
    ...
    public void step(double t) {
        if (t < 1.0) {
            value = startValue + t * (stopValue - startValue);
        } else {
            value = stopValue;
        }
    }
    ...
    @Override
    public LinearInterpolation copy() {
        return new LinearInterpolation(startValue, stopValue);
    }
}
