 ...
 */
@ComponentInfo(name = "Plugin Content Adder", category = "VRL/Development",
description = "Adds content to VRL-Plugin")
@ObjectInfo(controlFlowIn = true, controlFlowOut = true)
public class PluginContentAdder implements Serializable {
    ...
    public File addContent(
            ...
            @ParamInfo(name = "Content", style = "load-dialog",
            options = "endings=[\".zip\"];description=\"Content - *.zip\"") final File content,
    ...
    private static class AddLibraryPluginActionImpl
            implements vrl.devel.AddNativeLibrariesAction {
