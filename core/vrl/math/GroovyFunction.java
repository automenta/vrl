...
public class GroovyFunction implements Function, Serializable {
     ...
     */
    public GroovyFunction(String expression) {
     ...
     */
    public GroovyFunction(String expression, String xVarName) {
        setExpression(expression);
    ...
    public void setExpression(@ParamInfo(name="", style="code", options="") String expression) {
        this.expression = expression;
        GroovyShell shell = new GroovyShell();
        script = shell.parse("import static java.lang.Math.*; import eu.mihosoft.vrl.types.*; result = new Double[x.length]; " + expression);
    }
