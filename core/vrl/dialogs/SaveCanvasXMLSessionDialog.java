/* 
 * SaveCanvasXMLSessionDialog.java
 * 
...
import vrl.io.CanvasXMLSessionSaver;
...
public class SaveCanvasXMLSessionDialog {
    ...
    /**
     * Opens a save file dialog and loads a XML canvas session.
    ...
    public static void showDialog(Component parent, Object o) {
        ...
        dialogManager.saveFile(parent, o, new CanvasXMLSessionSaver(),
     ...
     */
    public static void showDialog(Component parent, Object o, File directory) {
        FileDialogManager dialogManager = new FileDialogManager();
        dialogManager.saveFile(parent, o, new CanvasXMLSessionSaver(),directory,
