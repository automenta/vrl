...
import vrl.annotation.ParamInfo;
 ...
 /**
  * Shows a dialog which allows to save the session with a user made
  * comment.
  * 
  * @author Christian Poliwoda <christian.poliwoda@gcsc.uni-frankfurt.de>
  */
@ObjectInfo(serialize = false, controlFlowIn=false, controlFlowOut=false)
public class CommitDialogInfo extends DialogUIClass{

    private String commitMessage;
    
    
    public CommitDialogInfo() {
        super(1);
    }
