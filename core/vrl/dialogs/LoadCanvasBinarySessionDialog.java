/* 
 * LoadCanvasBinarySessionDialog.java
 * 
 ...
 */
public class LoadCanvasBinarySessionDialog {

    /**
     * Opens a load file dialog and loads a binary canvas session which
    ...
    public static Object showDialog(Canvas parent) {
        ...
        return dialogManager.loadFile(parent, new CanvasBinarySessionLoader()
